...
const TermsOfService = () => {
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="January 9, 2026">
      <div className="_legal_section">
        <p>
          Welcome to Yieldbook. Please read these Terms of Service ("Terms")
      ...
      <div className="_legal_section">
        ...
        <p>
          Yieldbook is a web application developed as a student project for
          educational and evaluation purposes. It is not a commercial product
          and is not intended for real-world financial management. By accessing
          or using Yieldbook, you agree to be bound by these Terms. The
          platform and all its content are provided on an "as-is" and
      ...
      <div className="_legal_section">
        <h3>2. Eligibility</h3>
        <p>
          To use Yieldbook, you must be at least 18 years of age. By creating
          an account, you confirm that you meet this requirement. You are
          solely responsible for the accuracy of any information you provide
          during registration or post on the platform.
        </p>
      </div>
      ...
      <div className="_legal_section">
        ...
        <p>
          ...
          including your password. All activities that occur under your account
          are your responsibility. You agree to notify the project maintainers
