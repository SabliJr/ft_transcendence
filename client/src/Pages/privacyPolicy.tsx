    ...
    <main className='_policy_container'>
      ...
      <div className='_Policy_text_container'>
        ...
        <div className='_policy_text_div'>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>2. Information Collected</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>3. How Information Is Used</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>4. Data Storage</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>5. Third-Party Services</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>6. AI Features</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>7. Data Sharing</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>8. User Rights</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>9. Security</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>10. Children’s Privacy</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>11. Changes to This Privacy Policy</p>
            <p>
          ...
          <div className='_policy_first_section'>
            <p className='_p_num'>12. Contact</p>
            <p>
